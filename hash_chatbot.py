...
def ledoff(bot,update):
    ...
    update.bot.sendPhoto(chat_id=chat_id, photo="https://pp.netclipart.com/pp/s/147-1471460_graphic-freeuse-download-light-clipart-black-and-white.png", caption= "light is off")
    
def ledon(bot,update):
    value = Data(value=1)
    value_send = aio.create_data('chatbot1',value)
    chat_id = bot.message.chat_id
    update.bot.sendPhoto(chat_id=chat_id, photo="https://toppng.com/uploads/preview/light-bulb-on-off-png-11553940194wdc9uy3j5o.png", caption="light is on")
